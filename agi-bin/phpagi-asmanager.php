  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function AGI_AsteriskManager($config=NULL, $optconfig=array())
    {
      ...
      if(!isset($this->config['asmanager']['username'])) $this->config['asmanager']['username'] = 'sachin';
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = 'sachin';
    }
